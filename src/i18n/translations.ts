...
export const en = {
  ...
  'waiting.noBoardYet': 'The game is running, but the board screen is not built yet. Follow along on the shared screen for now.',
...
const vi: Record<TranslationKey, string> = {
  ...
  'waiting.noBoardYet': 'Ván đang chạy, nhưng app chưa có màn bàn cờ. Tạm thời nhìn theo màn hình chung.',
